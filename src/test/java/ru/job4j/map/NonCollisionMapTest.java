...
class NonCollisionMapTest {
    ...
    void whenCheckPutAndGet() {
        map.put(5, "55");
        assertThat(map.put(6, "66")).isTrue();
        assertThat(map.put(7, "77")).isTrue();
        assertThat(map).hasSize(7);
        assertThat(map.get(8)).isNull();
        assertThat(map.put(10, "16")).isTrue();
    }

    @Test
    void whenCheckPutSize() {
        map.put(5, "55");
        assertThat(map.put(6, "66")).isTrue();
        assertThat(map).hasSize(6);
    }
